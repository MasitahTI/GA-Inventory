<?php 
  ...
  $id = $_GET['id'];
  $query = "SELECT * FROM diserahkan WHERE id_diserahkan = '$id' LIMIT 1";
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="nav navbar-nav ml-auto">
                ...
                <form role="form"  method="POST" action="update_diserahkan.php">
                <div class="card-body">
                  <div class="row">
                  <div class="col-md-6">
                  <div class="form-group ">
                    <label for="nama">Nama</label>
                    <input type="hidden" class="form-control" name="id_diserahkan" value="<?php echo $row['id_diserahkan']; ?>">
