...
<!-- ------ -->
            ...
            <div class="card-header">
              MONITORING SERAH TERIMA RADIO HT
            </div>
            <div class="card-body">
              <a href="aset.php" class="btn btn-md btn-success" style="margin-bottom: 10px"><i class="fa fa-plus"></i></a><br>
              <!-- <a href="cetak_aset.php" class="btn btn-md btn-danger" style="margin-bottom: 10px">CETAK PDF</a><br> -->
              ...
              <table class="table table-bordered myTable">
                ...
                <tbody>
                   ...
                   <?php 
                      ...
                      if(isset($_GET['cari'])){
                        $cari = $_GET['cari'];
                        $query = mysqli_query($conn, "select * from ht where dapartemen like '%".$cari."%'"); 
                    }
                    else{
                      
                      $query = mysqli_query($conn,"SELECT `id_ht`, `tgl_masuk`, `tgl_keluar`, `description`, `asset`, `qty`, `sn`, `dapartemen`, `remark` FROM `ht` WHERE 1");
                    }
                    $no = 1;
                  ...
                  <tr>
                      ...
                      <a href="edit_aset.php?id=<?php echo $row['id_ht']; ?>" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                      <a href="hapus_aset.php?id=<?=$row['id_ht']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Anda yakin mau menghapus item ini ?')"><i class="fa fa-trash"></i></a>                      </td>
                  </tr>
