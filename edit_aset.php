<?php 
  ...
  $id = $_GET['id'];
  $query = "SELECT * FROM ht WHERE id_ht = '$id' LIMIT 1";
    ...
    <div class="container-fluid">
        ...
        <button class="btn btn-dark d-inline-block d-lg-none ml-auto" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
            <i class="fas fa-align-justify"></i>
                ...
                <form role="form"  method="POST" action="update_aset.php">
                <div class="card-body">
                  <div class="row">
                  <div class="col-md-6">
                  <div class="form-group">
                    <label for="exampleInputPassword1">Tanggal Masuk</label>
                    <input type="hidden" class="form-control" name="id_ht" value="<?php echo $row['id_ht']; ?>">
