...
<!-- ------ -->
            ...
            <div class="card-header">
              Data yang Menyerahkan
            </div>
            <div class="card-body">
              <!-- <a href="diserahkan.php" class="btn btn-md btn-success" style="margin-bottom: 10px">TAMBAH DATA</a><br> -->
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <a href="edit_diserahkan.php?id=<?php echo $row['id_diserahkan']; ?>" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
